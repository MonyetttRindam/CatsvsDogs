...
<div class="main-header">
    ...
    <p>AI-Powered Food Recognition • Identifikasi 101 Jenis Makanan dengan Teknologi Deep Learning CNN by Muhammad Abil Khoiri</p>
</div>
""", unsafe_allow_html=True)
...
<div class="info-box">
    ...
    1. Upload gambar makanan dalam format JPG, JPEG, atau PNG<br>
    2. Lihat hasil prediksi dengan tingkat kepercayaan tertinggi
</div>
""", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    <div style="text-align: center; padding: 3rem 1rem; color: #666;">
        ...
        <div style="margin-top: 2rem; font-size: 0.9rem; color: #888;">
            Didukung oleh teknologi Deep Learning
        </div>
    </div>
    """, unsafe_allow_html=True)
